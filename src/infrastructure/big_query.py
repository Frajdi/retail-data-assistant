...
class BigQueryRunner:
    ...
    def __init__(self, project_id: Optional[str] = None,
                 dataset_id: Optional[str] = "bigquery-public-data.thelook_ecommerce") -> None:
    ...
    def execute_query(self, sql_query: str) -> pd.DataFrame:
        ...
        # malformed SQL, invalid column, invalid function, etc.
            ...
            raise QueryExecutionError(
                error_type=QueryErrorType.PERMISSION,
                message=str(e),
            ) from e
        except TooManyRequests as e:
            raise QueryExecutionError(
                error_type=QueryErrorType.RATE_LIMIT,
                message=str(e),
            ) from e
        except ServiceUnavailable as e:
            raise QueryExecutionError(
            error_type=QueryErrorType.SERVICE,
            message=str(e),
            ) from e
        except Exception as e:
